...
from controllers.notification import get_all_notifications, post_notification, get_single_notification, delete_single_notification, patch_single_notification
...
class SingleNotification(Resource):
  ...
  def patch(self, id):
    return handle_request(request, lambda: patch_single_notification(id))